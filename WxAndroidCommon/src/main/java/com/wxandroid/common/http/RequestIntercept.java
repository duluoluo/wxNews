...
import com.wxandroid.common.utils.ZipHelper;
...
import static com.wxandroid.common.utils.LogUtils.jsonFormat;
...
public class RequestIntercept implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        //打印url信息
        LogUtils.e("Sending Request %s on %n Params --->  %s%n Connection ---> %s%n Headers ---> %s", request.url()
        ...
        LogUtils.e(jsonFormat(bodyString));
