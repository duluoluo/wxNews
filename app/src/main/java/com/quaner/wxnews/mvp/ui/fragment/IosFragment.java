package com.quaner.wxnews.mvp.ui.fragment;
...
import com.quaner.wxnews.inject.component.DaggerIosFragmentComponent;
import com.quaner.wxnews.inject.module.IosModule;
import com.quaner.wxnews.mvp.contract.IosContract;
import com.quaner.wxnews.mvp.presenter.IosPresenter;
import com.quaner.wxnews.mvp.ui.adapter.IosAdapter;
 ...
 * Created by wenxin
 */
public class IosFragment extends LoadingBaseFragment<IosPresenter>
    ...
    public void onRefresh() {
        page = 1;
        mPresenter.getIosDatas("iOS", page, Constants.INIT);
    }
    ...
    public void onLoadMoreRequested() {
        if (page >= MAX_PAGE) {
            ...
            ++page;
            mPresenter.getIosDatas("iOS", page, Constants.ADD);
        }
    }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        if (AppUtils.isNotEmpty(url)) {
            ...
            intent.putExtra("color", android.R.color.holo_red_light);
    ...
    private void setAdapter(List<GankEntity> results) {
        mAdapter = new IosAdapter(results);
